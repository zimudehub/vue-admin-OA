<template>
    <div>
      ...
      <el-button type="primary" @click="handleJsonView('buildForm')" style="margin-top: 10px">
...
<script>
  ...
  import Codemirror from "../components/codemirrorVue"
